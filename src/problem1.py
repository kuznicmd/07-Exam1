...
def problem1a(rectangle, square, thickness, window):
    ...
    endpoint1 = square.center
    endpoint2_x = (rectangle.get_upper_left_corner().x + rectangle.get_upper_right_corner().x) / 2
    endpoint2 = rg.Point(endpoint2_x, rectangle.get_upper_left_corner().y)

    line = rg.Line(endpoint1, endpoint2)
